...
func printSourceSyncUsage(cmdName string) {
	...
	fmt.Fprintln(os.Stderr, "                            match as path prefixes (e.g. 'vendor/'). A")
	fmt.Fprintln(os.Stderr, "                            .nlmignore file at the repo root adds patterns")
	fmt.Fprintln(os.Stderr, "                            automatically (one per line, '#' comments).")
