...
// RPC ID: VfAZjd
// Argument format: [%project_id%, [2, null, [1], [1, null, null, null, null, null, null, null, null, null, [1, 3]]]]
func EncodeGenerateNotebookGuideArgs(req *notebooklmv1alpha1.GenerateNotebookGuideRequest) []interface{} {
	...
	args, err := argbuilder.EncodeRPCArgs(req, "[%project_id%, [2, null, [1], [1, null, null, null, null, null, null, null, null, null, [1, 3]]]]")
	if err != nil {
