...
// ProjectDetails. The captured response in our corpus carries only
// the collaborators payload, not the title/emoji/thumbnail that the
// fields below also model. The legacy fields are retained for
// backward compatibility with consumers of the generated protos and
// may populate under request modes other than [2] (none observed
// yet).
//
// HAR-verified shape:
//
//	[
//	  [<owner_entry>, <collaborator_entry>, ...],
//	  <flags|null>,         // [true,true] when fully public, null o/w
//	  1000,                 // opaque limit
//	  true,
//	  null,
//	  null,
//	  [3, true, true],      // permissions blob (newer captures only)
//	]
//
//	Entry per user:
//	  [email, role_int, [], [display_name, avatar_url]]
//
//	  role_int 1 = OWNER (the only role observed in single-user captures)
//
// api.Client.parseProjectDetailsResponse (client.go:4463) extracts
// only OwnerName + IsPublic.
type ProjectDetails struct {
	...
	OwnerName string                 `protobuf:"bytes,4,opt,name=owner_name,json=ownerName,proto3" json:"owner_name,omitempty"` // populated from owner entry's display_name
	IsPublic  bool                   `protobuf:"varint,5,opt,name=is_public,json=isPublic,proto3" json:"is_public,omitempty"`   // populated from response [1] flags array
	...
	Collaborators []*ProjectCollaborator `protobuf:"bytes,8,rep,name=collaborators,proto3" json:"collaborators,omitempty"`
}
...
// ProjectCollaborator captures the actual per-user wire entry.
//
//	role_int observed values: 1 = OWNER. Other roles will appear once a
//	notebook with multiple collaborators is captured.
...
func (x *ProjectCollaborator) GetDisplayName() string {
	if x != nil {
...
func (x *ProjectCollaborator) GetAvatarUrl() string {
	if x != nil {
		return x.AvatarUrl
	}
	return ""
...
var file_notebooklm_v1alpha1_sharing_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x07, 0x73, 0x68, 0x61, 0x72, 0x65, 0x49, 0x64, 0x22, 0xde, 0x02, 0x0a, 0x0e,
	...
	0x61, 0x72, 0x79, 0x52, 0x07, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x12, 0x4e, 0x0a, 0x0d,
	0x63, 0x6f, 0x6c, 0x6c, 0x61, 0x62, 0x6f, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x73, 0x18, 0x08, 0x20,
	...
	0x74, 0x43, 0x6f, 0x6c, 0x6c, 0x61, 0x62, 0x6f, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x52, 0x0d, 0x63,
	0x6f, 0x6c, 0x6c, 0x61, 0x62, 0x6f, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x73, 0x22, 0x81, 0x01, 0x0a,
	0x13, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x43, 0x6f, 0x6c, 0x6c, 0x61, 0x62, 0x6f, 0x72,
	0x61, 0x74, 0x6f, 0x72, 0x12, 0x14, 0x0a, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x12, 0x12, 0x0a, 0x04, 0x72, 0x6f,
	0x6c, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x04, 0x72, 0x6f, 0x6c, 0x65, 0x12, 0x21,
	...
	0x22, 0x84, 0x01, 0x0a, 0x0d, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x53, 0x75, 0x6d, 0x6d, 0x61,
	0x72, 0x79, 0x12, 0x1b, 0x0a, 0x09, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x69, 0x64, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x49, 0x64, 0x12,
	0x14, 0x0a, 0x05, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05,
	0x74, 0x69, 0x74, 0x6c, 0x65, 0x12, 0x40, 0x0a, 0x0b, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f,
	0x74, 0x79, 0x70, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1f, 0x2e, 0x6e, 0x6f, 0x74,
	...
	0x72, 0x63, 0x65, 0x54, 0x79, 0x70, 0x65, 0x22, 0x74, 0x0a, 0x13, 0x53, 0x68, 0x61, 0x72, 0x65,
	...
	0x6e, 0x67, 0x73, 0x52, 0x08, 0x73, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x73, 0x22, 0xe0, 0x01,
	0x0a, 0x0d, 0x53, 0x68, 0x61, 0x72, 0x65, 0x53, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x73, 0x12,
	...
	,
	...
	0x73, 0x22, 0x68, 0x0a, 0x1a, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x41, 0x63, 0x63, 0x65, 0x73,
	...
	0x0a, 0x11, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x65, 0x72, 0x5f, 0x6d, 0x65, 0x73, 0x73,
	0x61, 0x67, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x10, 0x72, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x65, 0x72, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x3c, 0x0a, 0x1b, 0x43,
	...
	0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x49, 0x64, 0x22, 0xfa, 0x01, 0x0a, 0x09, 0x47, 0x75,
	0x69, 0x64, 0x65, 0x62, 0x6f, 0x6f, 0x6b, 0x12, 0x21, 0x0a, 0x0c, 0x67, 0x75, 0x69, 0x64, 0x65,
	0x62, 0x6f, 0x6f, 0x6b, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x67,
	0x75, 0x69, 0x64, 0x65, 0x62, 0x6f, 0x6f, 0x6b, 0x49, 0x64, 0x12, 0x1d, 0x0a, 0x0a, 0x70, 0x72,
	...
	0x52, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x12, 0x3c, 0x0a, 0x06, 0x73, 0x74, 0x61,
	0x74, 0x75, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x24, 0x2e, 0x6e, 0x6f, 0x74, 0x65,
	0x62, 0x6f, 0x6f, 0x6b, 0x6c, 0x6d, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x2e,
	0x47, 0x75, 0x69, 0x64, 0x65, 0x62, 0x6f, 0x6f, 0x6b, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52,
	0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x3d, 0x0a, 0x0c, 0x70, 0x75, 0x62, 0x6c, 0x69,
	...
	0x73, 0x68, 0x65, 0x64, 0x41, 0x74, 0x22, 0x3b, 0x0a, 0x16, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65,
	...
	0x6b, 0x49, 0x64, 0x22, 0x38, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x47, 0x75, 0x69, 0x64, 0x65, 0x62,
	0x6f, 0x6f, 0x6b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x21, 0x0a, 0x0c, 0x67, 0x75,
	0x69, 0x64, 0x65, 0x62, 0x6f, 0x6f, 0x6b, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x0b, 0x67, 0x75, 0x69, 0x64, 0x65, 0x62, 0x6f, 0x6f, 0x6b, 0x49, 0x64, 0x22, 0x61, 0x0a,
	0x23, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x63, 0x65, 0x6e, 0x74, 0x6c, 0x79, 0x56, 0x69, 0x65,
	...
	,
	...
	0x28, 0x09, 0x52, 0x0b, 0x67, 0x75, 0x69, 0x64, 0x65, 0x62, 0x6f, 0x6f, 0x6b, 0x49, 0x64, 0x12,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x67, 0x73, 0x22, 0x82, 0x01, 0x0a, 0x16, 0x47, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x74, 0x65, 0x41,
	0x6e, 0x73, 0x77, 0x65, 0x72, 0x53, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x73, 0x12, 0x1d, 0x0a,
	...
	0x02, 0x52, 0x0b, 0x74, 0x65, 0x6d, 0x70, 0x65, 0x72, 0x61, 0x74, 0x75, 0x72, 0x65, 0x12, 0x27,
	0x0a, 0x0f, 0x69, 0x6e, 0x63, 0x6c, 0x75, 0x64, 0x65, 0x5f, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65,
	0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0e, 0x69, 0x6e, 0x63, 0x6c, 0x75, 0x64, 0x65,
	0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x22, 0xa4, 0x01, 0x0a, 0x1f, 0x47, 0x75, 0x69, 0x64,
	0x65, 0x62, 0x6f, 0x6f, 0x6b, 0x47, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x74, 0x65, 0x41, 0x6e, 0x73,
	...
	0x77, 0x65, 0x72, 0x12, 0x3e, 0x0a, 0x07, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x18, 0x02,
	...
	0x65, 0x52, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x52, 0x07, 0x73, 0x6f, 0x75, 0x72,
	0x63, 0x65, 0x73, 0x12, 0x29, 0x0a, 0x10, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x64, 0x65, 0x6e, 0x63,
	0x65, 0x5f, 0x73, 0x63, 0x6f, 0x72, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x02, 0x52, 0x0f, 0x63,
	0x6f, 0x6e, 0x66, 0x69, 0x64, 0x65, 0x6e, 0x63, 0x65, 0x53, 0x63, 0x6f, 0x72, 0x65, 0x22, 0x5e,
	...
	,
	...
	0x73, 0x74, 0x1a, 0x23, 0x2e, 0x6e, 0x6f, 0x74, 0x65, 0x62, 0x6f, 0x6f, 0x6b, 0x6c, 0x6d, 0x2e,
	0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x2e, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74,
	0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x22, 0x1a, 0xc2, 0xf3, 0x18, 0x06, 0x4a, 0x46, 0x4d,
	0x44, 0x47, 0x64, 0xca, 0xf3, 0x18, 0x0c, 0x5b, 0x25, 0x73, 0x68, 0x61, 0x72, 0x65, 0x5f, 0x69,
	0x64, 0x25, 0x5d, 0x12, 0x8d, 0x01, 0x0a, 0x0c, 0x53, 0x68, 0x61, 0x72, 0x65, 0x50, 0x72, 0x6f,
	0x6a, 0x65, 0x63, 0x74, 0x12, 0x28, 0x2e, 0x6e, 0x6f, 0x74, 0x65, 0x62, 0x6f, 0x6f, 0x6b, 0x6c,
	0x6d, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x2e, 0x53, 0x68, 0x61, 0x72, 0x65,
	...
	0x70, 0x68, 0x61, 0x31, 0x2e, 0x53, 0x68, 0x61, 0x72, 0x65, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63,
	0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x28, 0xc2, 0xf3, 0x18, 0x06, 0x51,
	0x44, 0x79, 0x75, 0x72, 0x65, 0xca, 0xf3, 0x18, 0x1a, 0x5b, 0x25, 0x70, 0x72, 0x6f, 0x6a, 0x65,
	0x63, 0x74, 0x5f, 0x69, 0x64, 0x25, 0x2c, 0x20, 0x25, 0x73, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67,
	0x73, 0x25, 0x5d, 0x12, 0x84, 0x01, 0x0a, 0x13, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x41, 0x63,
	0x63, 0x65, 0x73, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x2f, 0x2e, 0x6e, 0x6f,
	0x74, 0x65, 0x62, 0x6f, 0x6f, 0x6b, 0x6c, 0x6d, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61,
	...
	,
	...
	,
	...
	,
	...
	,
...
var file_notebooklm_v1alpha1_sharing_proto_msgTypes = make([]protoimpl.MessageInfo, 29)
var file_notebooklm_v1alpha1_sharing_proto_goTypes = []interface{}{
	...
	(*ProjectCollaborator)(nil),                  // 5: notebooklm.v1alpha1.ProjectCollaborator
	(*SourceSummary)(nil),                        // 6: notebooklm.v1alpha1.SourceSummary
	(*ShareProjectRequest)(nil),                  // 7: notebooklm.v1alpha1.ShareProjectRequest
	(*ShareSettings)(nil),                        // 8: notebooklm.v1alpha1.ShareSettings
	(*ShareProjectResponse)(nil),                 // 9: notebooklm.v1alpha1.ShareProjectResponse
	(*CreateAccessRequestRequest)(nil),           // 10: notebooklm.v1alpha1.CreateAccessRequestRequest
	(*CreateAccessRequestResponse)(nil),          // 11: notebooklm.v1alpha1.CreateAccessRequestResponse
	(*Guidebook)(nil),                            // 12: notebooklm.v1alpha1.Guidebook
	(*DeleteGuidebookRequest)(nil),               // 13: notebooklm.v1alpha1.DeleteGuidebookRequest
	(*GetGuidebookRequest)(nil),                  // 14: notebooklm.v1alpha1.GetGuidebookRequest
	(*ListRecentlyViewedGuidebooksRequest)(nil),  // 15: notebooklm.v1alpha1.ListRecentlyViewedGuidebooksRequest
	(*ListRecentlyViewedGuidebooksResponse)(nil), // 16: notebooklm.v1alpha1.ListRecentlyViewedGuidebooksResponse
	(*PublishGuidebookRequest)(nil),              // 17: notebooklm.v1alpha1.PublishGuidebookRequest
	(*PublishSettings)(nil),                      // 18: notebooklm.v1alpha1.PublishSettings
	(*PublishGuidebookResponse)(nil),             // 19: notebooklm.v1alpha1.PublishGuidebookResponse
	(*GetGuidebookDetailsRequest)(nil),           // 20: notebooklm.v1alpha1.GetGuidebookDetailsRequest
	(*GuidebookDetails)(nil),                     // 21: notebooklm.v1alpha1.GuidebookDetails
	(*GuidebookSection)(nil),                     // 22: notebooklm.v1alpha1.GuidebookSection
	(*GuidebookAnalytics)(nil),                   // 23: notebooklm.v1alpha1.GuidebookAnalytics
	(*ShareGuidebookRequest)(nil),                // 24: notebooklm.v1alpha1.ShareGuidebookRequest
	(*ShareGuidebookResponse)(nil),               // 25: notebooklm.v1alpha1.ShareGuidebookResponse
	(*GuidebookGenerateAnswerRequest)(nil),       // 26: notebooklm.v1alpha1.GuidebookGenerateAnswerRequest
	(*GenerateAnswerSettings)(nil),               // 27: notebooklm.v1alpha1.GenerateAnswerSettings
	(*GuidebookGenerateAnswerResponse)(nil),      // 28: notebooklm.v1alpha1.GuidebookGenerateAnswerResponse
	(*SourceReference)(nil),                      // 29: notebooklm.v1alpha1.SourceReference
	(*timestamppb.Timestamp)(nil),                // 30: google.protobuf.Timestamp
	(SourceType)(0),                              // 31: notebooklm.v1alpha1.SourceType
	(*emptypb.Empty)(nil),                        // 32: google.protobuf.Empty
}
var file_notebooklm_v1alpha1_sharing_proto_depIdxs = []int32{
	30, // 0: notebooklm.v1alpha1.ProjectDetails.shared_at:type_name -> google.protobuf.Timestamp
	6,  // 1: notebooklm.v1alpha1.ProjectDetails.sources:type_name -> notebooklm.v1alpha1.SourceSummary
	5,  // 2: notebooklm.v1alpha1.ProjectDetails.collaborators:type_name -> notebooklm.v1alpha1.ProjectCollaborator
	31, // 3: notebooklm.v1alpha1.SourceSummary.source_type:type_name -> notebooklm.v1alpha1.SourceType
	8,  // 4: notebooklm.v1alpha1.ShareProjectRequest.settings:type_name -> notebooklm.v1alpha1.ShareSettings
	30, // 5: notebooklm.v1alpha1.ShareSettings.expiry_time:type_name -> google.protobuf.Timestamp
	8,  // 6: notebooklm.v1alpha1.ShareProjectResponse.settings:type_name -> notebooklm.v1alpha1.ShareSettings
	0,  // 7: notebooklm.v1alpha1.Guidebook.status:type_name -> notebooklm.v1alpha1.GuidebookStatus
	30, // 8: notebooklm.v1alpha1.Guidebook.published_at:type_name -> google.protobuf.Timestamp
	12, // 9: notebooklm.v1alpha1.ListRecentlyViewedGuidebooksResponse.guidebooks:type_name -> notebooklm.v1alpha1.Guidebook
	18, // 10: notebooklm.v1alpha1.PublishGuidebookRequest.settings:type_name -> notebooklm.v1alpha1.PublishSettings
	12, // 11: notebooklm.v1alpha1.PublishGuidebookResponse.guidebook:type_name -> notebooklm.v1alpha1.Guidebook
	12, // 12: notebooklm.v1alpha1.GuidebookDetails.guidebook:type_name -> notebooklm.v1alpha1.Guidebook
	22, // 13: notebooklm.v1alpha1.GuidebookDetails.sections:type_name -> notebooklm.v1alpha1.GuidebookSection
	23, // 14: notebooklm.v1alpha1.GuidebookDetails.analytics:type_name -> notebooklm.v1alpha1.GuidebookAnalytics
	30, // 15: notebooklm.v1alpha1.GuidebookAnalytics.last_viewed:type_name -> google.protobuf.Timestamp
	8,  // 16: notebooklm.v1alpha1.ShareGuidebookRequest.settings:type_name -> notebooklm.v1alpha1.ShareSettings
	27, // 17: notebooklm.v1alpha1.GuidebookGenerateAnswerRequest.settings:type_name -> notebooklm.v1alpha1.GenerateAnswerSettings
	29, // 18: notebooklm.v1alpha1.GuidebookGenerateAnswerResponse.sources:type_name -> notebooklm.v1alpha1.SourceReference
	1,  // 19: notebooklm.v1alpha1.LabsTailwindSharingService.ShareAudio:input_type -> notebooklm.v1alpha1.ShareAudioRequest
	3,  // 20: notebooklm.v1alpha1.LabsTailwindSharingService.GetProjectDetails:input_type -> notebooklm.v1alpha1.GetProjectDetailsRequest
	7,  // 21: notebooklm.v1alpha1.LabsTailwindSharingService.ShareProject:input_type -> notebooklm.v1alpha1.ShareProjectRequest
	10, // 22: notebooklm.v1alpha1.LabsTailwindSharingService.CreateAccessRequest:input_type -> notebooklm.v1alpha1.CreateAccessRequestRequest
	13, // 23: notebooklm.v1alpha1.LabsTailwindGuidebooksService.DeleteGuidebook:input_type -> notebooklm.v1alpha1.DeleteGuidebookRequest
	14, // 24: notebooklm.v1alpha1.LabsTailwindGuidebooksService.GetGuidebook:input_type -> notebooklm.v1alpha1.GetGuidebookRequest
	15, // 25: notebooklm.v1alpha1.LabsTailwindGuidebooksService.ListRecentlyViewedGuidebooks:input_type -> notebooklm.v1alpha1.ListRecentlyViewedGuidebooksRequest
	17, // 26: notebooklm.v1alpha1.LabsTailwindGuidebooksService.PublishGuidebook:input_type -> notebooklm.v1alpha1.PublishGuidebookRequest
	20, // 27: notebooklm.v1alpha1.LabsTailwindGuidebooksService.GetGuidebookDetails:input_type -> notebooklm.v1alpha1.GetGuidebookDetailsRequest
	24, // 28: notebooklm.v1alpha1.LabsTailwindGuidebooksService.ShareGuidebook:input_type -> notebooklm.v1alpha1.ShareGuidebookRequest
	26, // 29: notebooklm.v1alpha1.LabsTailwindGuidebooksService.GuidebookGenerateAnswer:input_type -> notebooklm.v1alpha1.GuidebookGenerateAnswerRequest
	2,  // 30: notebooklm.v1alpha1.LabsTailwindSharingService.ShareAudio:output_type -> notebooklm.v1alpha1.ShareAudioResponse
	4,  // 31: notebooklm.v1alpha1.LabsTailwindSharingService.GetProjectDetails:output_type -> notebooklm.v1alpha1.ProjectDetails
	9,  // 32: notebooklm.v1alpha1.LabsTailwindSharingService.ShareProject:output_type -> notebooklm.v1alpha1.ShareProjectResponse
	11, // 33: notebooklm.v1alpha1.LabsTailwindSharingService.CreateAccessRequest:output_type -> notebooklm.v1alpha1.CreateAccessRequestResponse
	32, // 34: notebooklm.v1alpha1.LabsTailwindGuidebooksService.DeleteGuidebook:output_type -> google.protobuf.Empty
	12, // 35: notebooklm.v1alpha1.LabsTailwindGuidebooksService.GetGuidebook:output_type -> notebooklm.v1alpha1.Guidebook
	16, // 36: notebooklm.v1alpha1.LabsTailwindGuidebooksService.ListRecentlyViewedGuidebooks:output_type -> notebooklm.v1alpha1.ListRecentlyViewedGuidebooksResponse
	19, // 37: notebooklm.v1alpha1.LabsTailwindGuidebooksService.PublishGuidebook:output_type -> notebooklm.v1alpha1.PublishGuidebookResponse
	21, // 38: notebooklm.v1alpha1.LabsTailwindGuidebooksService.GetGuidebookDetails:output_type -> notebooklm.v1alpha1.GuidebookDetails
	25, // 39: notebooklm.v1alpha1.LabsTailwindGuidebooksService.ShareGuidebook:output_type -> notebooklm.v1alpha1.ShareGuidebookResponse
	28, // 40: notebooklm.v1alpha1.LabsTailwindGuidebooksService.GuidebookGenerateAnswer:output_type -> notebooklm.v1alpha1.GuidebookGenerateAnswerResponse
