...
//
// The live path decodes this through the generated message and projects only
// OwnerName + IsPublic. printShareDetails
...
// are not on the wire) for the public projection; the wire fields carry the
// actual HAR positions for betool/beprotojson decode.
